...
/** @type {string} */
const CACHE_VERSION = '1771895789|472063107';
/** @type {string} */
const CACHE_PREFIX = 'BioChem Physica-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'BIOCHEMPHYSICA.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["BIOCHEMPHYSICA.html","BIOCHEMPHYSICA.js","BIOCHEMPHYSICA.offline.html","BIOCHEMPHYSICA.icon.png","BIOCHEMPHYSICA.apple-touch-icon.png","BIOCHEMPHYSICA.audio.worklet.js","BIOCHEMPHYSICA.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["BIOCHEMPHYSICA.wasm","BIOCHEMPHYSICA.pck","BIOCHEMPHYSICA.side.wasm"];
